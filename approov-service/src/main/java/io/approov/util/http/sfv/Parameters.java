...
public class Parameters implements Map<String, Item<?>> {
    ...
    // delegate methods, autogenerated; the java.util.function based default methods of
    // Map are deliberately not overridden because their types require Android API 24
    // while this library has a lower minSdk (the inherited defaults behave equivalently
    // on devices that provide them)
